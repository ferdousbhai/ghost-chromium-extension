...
Install it from the [Chrome Web Store](https://chromewebstore.google.com/detail/ghost/hiikecmfleghkggknndabdkmlmnohpbm).

To run the source instead, load it unpacked from this repo — the repository
root *is* the extension — or from the zip attached to the
